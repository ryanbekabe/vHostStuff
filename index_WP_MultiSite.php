...
echo '<p>_SERVER'.$_SERVER['SERVER_NAME'];
echo '<p>ipserver'.$ipserver;
echo '<p>postdata'.$postdata;
echo '<p>URI'.$URI;
echo '<p>VarHeader'.$VarHeader;
echo '<p>headerList'.$headerList;
echo '<p>requestbody'.$requestbody;
*/

echo '<pre>
.:: Selamat Datang ::.
Website ini (https://www.mafaza.xyz) bagian dari project HanyaJasa.Com - bekabeipa@gmail.com - 2020

Jika ingin mengakses Sub-Domain yang sudah Anda buat dari Mafaza.xyz, silakan gunakan https.
https://sub_domain_webmu.mafaza.xyx
Misal : https://samo.mafaza.xyz

Mungkin web yang ingin Anda tuju adalah : <a href=https://'.$_SERVER["SERVER_NAME"].'>https://'.$_SERVER["SERVER_NAME"].'</a>
</pre>';
?>
